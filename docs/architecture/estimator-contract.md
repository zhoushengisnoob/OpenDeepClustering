...
|---|---|---|---|---|
| Sequential | frozen after representation learning | external/second stage | representation→clustering | `transform` |
...
DEC and IDEC are the first simultaneous reference implementations. A new family may reuse validation, adapters and fit state while implementing a different orchestration class.
